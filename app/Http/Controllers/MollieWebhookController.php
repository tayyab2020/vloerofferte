...
//         $invoice_update = invoices::where('id','=',$inv_id)->update(['partial_paymentLink' => $payment_url]);
                    ...
                    else // Dutch Email Template
                    {
                        ...
                        $msg = "Beste ". $client_name .",<br><br> Je aanbetaling op je reservering is ontvangen. Het restant dient 7 dagen voor aanvang van de klus voldaan te worden " . $due_date . ". We hebben een totaalbedrag ontvangen van € " . $paid_amount .". Het restant kan voldaan worden door naar reserveringen te gaan en te klikken op restant betalen. Klik op account om de status van je reservering te bekijken <a href='".$client_dash."'>account.</a><br><br>Met vriendelijke groeten,<br><br>Klantenservice<br><br> Vloerofferteonline";
                        mail($user_email,$subject,$msg,$headers);
                    ...
                    if($data->language == 'eng') // English Email Template
                        {
                            ...
                            $headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
                            $subject = "New Booking!";
                            $msg = "Dear Mr/Mrs ". $client_name .",<br><br>Your booking has been made. We have received a total amount of € " . $paid_amount .". For further details visit your client panel through <a href='".$client_dash."'>here.</a><br><br>Kind regards,<br><br>Klantenservice<br><br> Vloerofferteonline";
                            mail($user_email,$subject,$msg,$headers);
                        }
                    else //Dutch Email Template
                    {
                        ...
                        $msg = "Beste ". $client_name .",<br><br>Je reservering is geslaagd. Wij hebben een totaalbedrag van € " . $paid_amount ." ontvangen. Om je reservering te bekijken, klik op account <a href='".$client_dash."'>account.</a><br><br>Met vriendelijke groeten,<br><br>Klantenservice<br><br> Vloerofferteonline";
                        mail($user_email,$subject,$msg,$headers);
                    }
                ...
                else //Dutch Email Template
                {
                    ...
                    $headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
                    $subject = "Nieuwe reservering!";
                    $msg = "Beste ". $handyman_name .",<br><br>Je hebt een nieuwe reservering. Graag de opdracht binnen 48 uur accepteren. We hebben een totaalbedrag ontvangen van € " . $paid_amount .". Voor meer informatie over de boeking, klik op de link <a href='".$handyman_dash."'>account.</a><br><br>Met vriendelijke groeten,<br><br>Klantenservice<br><br> Vloerofferteonline";
                    mail($handyman_email,$subject,$msg,$headers);
                }
