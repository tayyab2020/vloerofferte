...
$msg = "Dear Mr/Mrs ". $client_name .",<br><br>Your full payment for your booking has been received. For further details visit your client panel through <a href='".$client_dash."'>here.</a><br><br>Kind regards,<br><br>Klantenservice Topstoffeerders.";
...
$msg = "Dear Mr/Mrs ". $handyman_name .",<br><br>Payment status for one of your bookings has been changed from partial to full. Kindly review your bookings before it get expired. You can visit your profile dashboard through <a href='".$handyman_dash."'>here.</a><br><br>Kind regards,<br><br>Klantenservice Topstoffeerders.";
...
$msg = "Beste ". $client_name .",<br><br>Wij hebben het resterende bedrag op je reservering ontvangen. Klik op account om de status van je klus te bekijken <a href='".$client_dash."'>account.</a><br><br>Met vriendelijke groet,<br><br>Klantenservice Topstoffeerders.";
...
$headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
$subject = "Restant factuurbedrag voldaan!";
$msg = "Beste ". $handyman_name .",<br><br>wij hebben het resterende bedrag op je reservering ontvangen van de oprachtgever. Zodra, de klus is afgerond maken wij het geld over op je rekening. Klik op account om de status van je klus te bekijken <a href='".$handyman_dash."'>account.</a><br><br>Met vriendelijke groet,<br><br>Klantenservice Topstoffeerders.";
