...
$payment = $mollie->customers->get($handyman->mollie_customer_id)->createPayment([
 ...
 $post = bookings::where('invoice_id','=',$request->item_id)->update(['is_booked' => 1,'is_completed' => 1,'pay_req' => 1,'is_paid' => 1]);
        ...
        $subject = "Booking Payment!";
            $msg = "Dear Mr/Mrs ".$user->name. " ".$user->family_name.",<br><br>We have transferred your payment into Mr/Mrs. ".$handyman->name. " ".$handyman->family_name."'s account. You can visit your profile dashboard through <a href='".$client_dash."'>here.</a><br><br>Kind regards,<br><br>Klantenservice Vloerofferteonline";
            ...
            $headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
        $subject = "Betaling!";
            $msg = "Beste Mr/Mrs ".$user->name. " ".$user->family_name.",<br><br>we hebben de stoffeerder uitbetaald Mr/Mrs. ".$handyman->name. " ".$handyman->family_name."'s account. Klik op account om de status van je klus te bekijken <a href='".$client_dash."'>account.</a><br><br>Met vriendeijke groet,<br><br>Klantenservice Vloerofferteonline";
            mail($user_email,$subject,$msg,$headers);
            ...
            $headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
        $subject = "Booking Payment!";
            $msg = "Dear Mr/Mrs ".$handyman->name. " ".$handyman->family_name.",<br><br>We have transferred payment from your client Mr/Mrs. ".$user->name. " ".$user->family_name." into your account. You can visit your profile dashboard through <a href='".$handyman_dash."'>here.</a><br><br>Kind regards,<br><br>Klantenservice Vloerofferteonline";
            ...
            $headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
        $subject = "Uitbetaling";
            $msg = "Beste ".$handyman->name. " ".$handyman->family_name.",<br><br>we hebben je factuur van klus Mr/Mrs. ".$user->name . " ".$user->family_name." uitbetaald. Klik op account om de status van je klus te bekijken <a href='".$handyman_dash."'>account.</a><br><br>Met vriendelijke groet,<br><br>Klantenservice Vloerofferteonline";
            mail($handyman_email,$subject,$msg,$headers);
...
$amount_refund = $thirty_amount;
    ...
    $settings = Generalsetting::where('id',1)->update(['counter'=>$counter]);
        ...
        $subject = "Booking Cancelled!";
            ...
            $headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
        $subject = "Booking Cancelled!";
            $msg = "Dear Mr/Mrs ".$handyman->name. " ".$handyman->family_name.",<br><br>Your booking has been cancelled from your client Mr/Mrs. ".$user->name. ' '.$user->family_name.". You can visit your profile dashboard through <a href='".$handyman_dash."'>here.</a><br><br>Kind regards,<br><br>Klantenservice Vloerofferteonline";
            mail($handyman_email,$subject,$msg,$headers);
        ...
        $subject = "Klus geannuleerd!";
            $msg = "Beste ".$handyman->name. " ".$handyman->family_name.",<br><br>de klant heeft de reservering geannuleerd Mr/Mrs. ".$user->name. ' '.$user->family_name.". Klik op account om de status van je klus te bekijken <a href='".$handyman_dash."'>account.</a><br><br>Met vriendelijke groet,<br><br>Klantenservice Vloerofferteonline";
            mail($handyman_email,$subject,$msg,$headers);
