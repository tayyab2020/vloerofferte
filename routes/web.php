...
*/
  ...
  Route::get('/quotation-payment-redirect-page/{id}', 'UserController@QuotationPaymentRedirectPage');
  ...
  Route::post('/create-custom-invoice', 'UserController@StoreCustomQuotation')->name('post-custom-invoice');
  Route::get('/view-quotation/{id}', 'UserController@ViewQuotation')->name('view-handyman-quotation');
  Route::get('/view-custom-quotation/{id}', 'UserController@ViewCustomQuotation')->name('view-custom-quotation');
  Route::get('/edit-quotation/{id}', 'UserController@ViewQuotation')->name('edit-handyman-quotation');
  Route::get('/edit-custom-quotation/{id}', 'UserController@ViewCustomQuotation')->name('edit-custom-quotation');
  Route::get('/create-invoice/{id}', 'UserController@ViewQuotation')->name('create-handyman-invoice');
  Route::get('/create-custom-invoice/{id}', 'UserController@ViewCustomQuotation')->name('create-custom-invoice');
  Route::get('/quotation/{id}', 'UserController@ViewClientQuotation')->name('view-client-quotation');
  Route::get('/custom-quotation/{id}', 'UserController@ViewClientCustomQuotation')->name('view-client-custom-quotation');
