            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="panel panel-default admin">
                        <div class="panel-heading admin-title" style="text-align: center;">{{$lang->eyt}}</div>
...
<input type="hidden" name="email" placeholder="Email" readonly value="{{$user->email}}" >
                                            ...
                                            <p style="font-size: 18px;">{{$lang->eyn}}
<br><strong>{{$lang->fet}}:</strong> {{$lang->eyex}}</p>

                                            @if($user->experience_years == '')

<input type="number" id="years" step="any" name="years" placeholder="{{$lang->eyp}}" value="" required style="width: 100%;text-align: center;padding: 30px;font-size: 20px;">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-8 col-md-offset-2">
                                                        <div class="form-group text-center">
                                                            <button class="boxed-btn blog" type="button" onclick="myFunction()" style="font-size: 20px;">{{$lang->fpb}}</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<input type="number" id="years" name="years" placeholder="{{$lang->eyp}}" value="{{$user->experience_years}}"   step="any"  required style="width: 100%;text-align: center;padding: 30px;font-size: 20px;">
