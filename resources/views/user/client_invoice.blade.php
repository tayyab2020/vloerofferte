...
<div class="right-side">
  ...
  <!-- Page Content -->
    <section class="jumbotron text-center">
        <div class="container">
            <h1 class="jumbotron-heading">{{$lang->it1}}</h1>
        </div>
    </section>
                    ...
                    <div class="card-body p-0">
                        <div class="row p-5">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 text-right inv-rigth" style="float: right;margin-top: 50px;">
                                ...
                                <?php $date12 = strtotime($invoice[0]->inv_date);

                                $invoice_number =  'INV# ' .  date("Y",$date12) . "-" . $invoice[0]->invoice_number ?>
                                ...
                                <p class="text-muted" style="font-size: 14px;">{{$lang->hbdih}}: {{$booking_date}}</p>
                        ...
                        <div class="row pb-5 p-5">
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <p class="font-weight-bold mb-4 m-heading">{{$lang->clit1}}</p>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 text-right m2-heading" style="float: right;">
                                <p class="font-weight-bold mb-4 m-heading">{{$lang->hit1}}</p>
                                ...
                                <table class="table" style="border: 1px solid #e5e5e5;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="border-0 text-uppercase small font-weight-bold">{{$lang->chs}}</th>
                                            <th class="border-0 text-uppercase small font-weight-bold">{{$lang->chst}}</th>
                                            <th class="border-0 text-uppercase small font-weight-bold">{{$lang->csd}}</th>
                                            <th class="border-0 text-uppercase small font-weight-bold">{{$lang->sr}}</th>
                                            <th class="border-0 text-uppercase small font-weight-bold">{{$lang->cbd}}</th>
                                            <th class="border-0 text-uppercase small font-weight-bold">{{$lang->ctot}}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @if($key->type == 'Per Hour Rate')

                                                    {{$lang->servT1}}

                                            @elseif($key->type == 'Per Meter Rate')

                                                    {{$lang->servT2}}

                                            @elseif($key->type == 'Per Foot Rate')

                                                    {{$lang->servT3}}

                                            @elseif($key->type == 'Per Piece Rate')
                                ...
                                <div class="col-md-12" style="overflow-x: auto">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <th class="border-0 text-uppercase small font-weight-bold">{{$lang->sct}}</th>


                                            @if($invoice[0]->is_cancelled == 1)

                                            <th class="border-0 text-uppercase small font-weight-bold">{{$lang->art1}}</th>

                                            <th class="border-0 text-uppercase small font-weight-bold">{{$lang->apt1}}</th>
                                            ...
                                            <th class="border-0 text-uppercase small font-weight-bold">{{$lang->cvat}}<small style="font-size: 11px;"> (<?php echo $invoice[0]->vat_percentage; ?>%)</small></th>

                                            <th class="border-0 text-uppercase small font-weight-bold">{{$lang->csf}}</th>

                                            <th class="border-0 text-uppercase small font-weight-bold">{{$lang->subtt1}}</th>

                                            <th class="border-0 text-uppercase small font-weight-bold">{{$lang->gtt1}}</th>
