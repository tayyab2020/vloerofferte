...
<div class="right-side">
  ...
  <!-- Page Content -->
    <section class="jumbotron text-center">
        <div class="container">
            <h1 class="jumbotron-heading">{{$lang->nit1}}</h1>
        </div>
    </section>
                    ...
                    <div class="card-body p-0">
                        <div class="row p-5">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 text-right inv-rigth" style="float: right;margin-top: 50px;">
                                ...
                                $invoice_number =  'INV# ' .  date("Y",$date12) . "-" . $invoice_number ?>
                                ...
                                <p class="text-muted" style="font-size: 14px;">{{$lang->cbdih}}: {{$booking_date}}</p>
