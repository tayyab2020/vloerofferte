...
<div class="right-side">
  ...
  <!-- Page Content -->
    <section class="jumbotron text-center">
        <div class="container">
            <h1 class="jumbotron-heading">{{$lang->it}}</h1>
        </div>
    </section>
                    ...
                    <div class="card-body p-0">
                        <div class="row p-5">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 text-right inv-rigth" style="float: right;margin-top: 50px;">
                                ...
                                $invoice_number =  'INV# ' .  date("Y",$date21) . "-" .  sprintf('%04u', $handyman->id)  . "-" . $invoice[0]->invoice_number ?>
                        ...
                        <div class="row pb-5 p-5">
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <p class="font-weight-bold mb-4 m-heading">{{$lang->hit}}</p>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 text-right m2-heading" style="float: right;">
                                <p class="font-weight-bold mb-4 m-heading">{{$lang->clit}}</p>
                                ...
                                <table class="table" style="border: 1px solid #e5e5e5;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="border-0 text-uppercase small font-weight-bold">{{$lang->iservt}}</th>
                                            <th class="border-0 text-uppercase small font-weight-bold">{{$lang->istt}}</th>
                                            <th class="border-0 text-uppercase small font-weight-bold">{{$lang->isdt}}</th>
                                            <th class="border-0 text-uppercase small font-weight-bold">{{$lang->isrt}}</th>
                                            <th class="border-0 text-uppercase small font-weight-bold">{{$lang->ibdt}}</th>
                                            <th class="border-0 text-uppercase small font-weight-bold">{{$lang->itat}}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                            ...
                            <div class="col-md-12" style="overflow-x: auto">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <th class="border-0 text-uppercase small font-weight-bold">{{$lang->hcp}}<small style="font-size: 11px;"> (<?php echo $invoice[0]->commission_percentage; ?>%)</small></th>
