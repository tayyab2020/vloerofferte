            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="reference-OS-area">
                        ...
                        <form class="form-horizontal" id="form" action="{{route('user-radius-update',$user->id)}}" method="POST" enctype="multipart/form-data">
...
<input data-id="1" class="required zipInput form-control" name="zipcode" type="text" size="7" maxlength="7" value="{{$terminal->zipcode}}" style="width:135px;font-size:18px;float: left;" required />



@else

<input data-id="1" class="required zipInput form-control" name="zipcode" type="text" size="7" maxlength="7" value="" style="width:135px;font-size:18px;float: left;" required />
...
<td>
<select data-id="1" name="radius" id="radius" class="required radiusInput form-control"  style="width: 200px;font-size:18px;">

@if($terminal != '')



<!-- <option value="" selected>No Radius</option>
...
<input type="hidden" name="postal_code" id="postal_code"  value="{{$terminal->zipcode}}"  required>
<input type="hidden" name="longitude" id="longitude"  value="{{$terminal->longitude}}"  required>
<input type="hidden" name="latitude" id="latitude"  value="{{$terminal->latitude}}"  required>
<input type="hidden" name="terminal_city" id="terminal_city"  value="{{$terminal->city}}"  required>
...
<input type="hidden" name="postal_code" id="postal_code"  value=""  required>
<input type="hidden" name="longitude" id="longitude"  value=""  required>
<input type="hidden" name="latitude" id="latitude"  value=""  required>
<input type="hidden" name="terminal_city" id="terminal_city"  value=""  required>
...
// }); //end addListener
                        ...
                        function handleCircles(clear) {
                            ...
                            for (var region in regionData) {
                                regionData[region].center = { lat: regionData[region].latitude, lng: regionData[region].longitude };
