                                ...
                                <div class="well" style="height: 300px;">
                                    ...
                                    <div style="margin-bottom: 40px;">
                                        ...
                                        <select class="js-data-example-ajax2 form-control quote-service quote_validation" style="height: 40px;" name="quote_service" id="blood_grp" required>
                                            ...
                                            <option selected value="{{$product->category_id}}">{{$product->cat_name}}</option>
                                    ...
                                    <div style="margin-bottom: 40px;">
                                        ...
                                        <select class="js-data-example-ajax6 form-control quote-model quote_validation" style="height: 40px;" name="quote_model" id="blood_grp" required>
                                            ...
                                            <option selected value="{{$product->model_id}}">{{$product->model_name}}</option>
                                    ...
                                    <div style="margin-bottom: 40px;">
                                        ...
                                        <input style="height: 40px;border: 1px solid #e1e1e1;" type="text" name="quote_model_number" placeholder="{{__('text.Model Number (Optional)')}}" class="form-control quote_model_number">
            ...
            $('.start-btn').click(function(){
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('.quote_model_number').val(model_number);
