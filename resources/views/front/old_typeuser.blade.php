                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6">
                        <div class="team_common">
                            <div class="member_img">
                                <a href="{{route('front.user',$user->id)}}"><img src="{{ $user->photo ? asset('assets/images/'.$user->photo):'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSCM_FnlKpZr_N7Pej8GA40qv63zVgNc0MFfejo35drsuxLUcYG'}}" alt="member image"></a>
                            </div>
                            <div class="member_info text-center pos_relative">
                                <div class="overlay1"></div>
                                <div class="overlay2"></div>
                                <div class="content">
                                    <a href="{{route('front.user',$user->id)}}" class="d_inline fw_600">{{$user->name}}</a>
                                    <span class="d_block transition_3s">{{$lang->bg}} {{$user->category->cat_name}}</span>
