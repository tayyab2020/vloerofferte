...
<div class="jumbotron text-center" style="font-family: inherit;height: 470px;background-color: #e9ecef;padding-top: 100px;">
  ...
  <p class="lead" style="font-size: 18px;width: 80%;margin: auto;padding-top: 55px;"> Kindly visit your dashboard panel and change the booking status for this invoice to get fresh checkout url to complete your remaining transaction. This could be server side error or your checkout url has expired.</p>
  <hr>
