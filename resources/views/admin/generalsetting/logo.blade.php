                                    ...
                                    <div class="add-product-box">
                                        ...
                                        <form class="form-horizontal" action="{{route('admin-gs-logoup')}}" method="POST" enctype="multipart/form-data">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                        <img width="130px" height="90px" id="adminimg" src="{{ $data->logo ? asset('assets/images/'.$data->logo):'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSCM_FnlKpZr_N7Pej8GA40qv63zVgNc0MFfejo35drsuxLUcYG'}}" alt="" id="adminimg">
                                            </div>
                                          </div>
                                          <div class="form-group">
