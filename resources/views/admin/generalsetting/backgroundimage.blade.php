                                        ...
                                        <form class="form-horizontal" action="{{route('admin-gs-bgimgup')}}" method="POST" enctype="multipart/form-data">
                                         @include('includes.form-error')
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                        <img width="130px" height="90px" id="adminimg" src="{{ $data->bgimg ? asset('assets/images/'.$data->bgimg):'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSCM_FnlKpZr_N7Pej8GA40qv63zVgNc0MFfejo35drsuxLUcYG'}}" alt="" id="adminimg">      
                                            </div>
                                          </div>
                                          <div class="form-group">
