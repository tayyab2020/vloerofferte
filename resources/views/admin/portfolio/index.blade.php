                                            ...
                                            @foreach($ads as $ad)                                                
                                              <tr role="row" class="odd">
                                                    ...
                                                    <td>{{$ad->designation}}</td>
                                                      <td tabindex="0" class="sorting_1"><img src="{{ $ad->photo ? asset('assets/images/'.$ad->photo):'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSCM_FnlKpZr_N7Pej8GA40qv63zVgNc0MFfejo35drsuxLUcYG'}}" alt="Ad Photo" style="height: 180px; width: 200px"></td>
                                                      <td>
