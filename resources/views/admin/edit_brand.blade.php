...
@section('title', trans('Edit Brand - Mera Brand'))
    ...
    $('.alert').fadeIn().delay(3000).fadeOut();
                        ...
                        <div class="row">
                            <div class="col-md-4 bg-light card-body">
                                <h5>Edit Brand</h5>
                                <form enctype="multipart/form-data" role="form" method="POST" action="../update_brand">
                                {{ csrf_field() }}
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input id="text" name="brand" class="form-control here" type="text" required value="{{$result->brand}}">
                                            <input id="text" name="org_brand" class="form-control here" type="hidden" value="{{$result->brand}}">
...
function showFileName( event ) {
  ...
  infoArea.textContent = 'File name: ' + fileName;
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <button name="submit" type="submit" class="btn btn-primary btn-sm">Edit Brand</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
