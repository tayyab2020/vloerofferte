...
@section('content')
    ...
    <section class="jumbotron text-center">
        <div class="container">
            <h1 class="jumbotron-heading">Client Invoice</h1>
        </div>
    </section>
                    ...
                    <div class="card-body p-0">
                        <div class="row p-5" style="margin-right: 15px !important;">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 text-right inv-rigth" style="float: right;margin-top: 50px;">
                                ...
                                $invoice_number =  'INV# ' .  date("Y",$date) . "-" . $invoice[0]->invoice_number ?>
                        ...
                        <div class="row pb-5 p-5" style="margin-right: 15px !important;">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 text-right m-heading" style="float: right;">
                                <p class="font-weight-bold mb-4 m2-heading" >Handyman Information</p>
